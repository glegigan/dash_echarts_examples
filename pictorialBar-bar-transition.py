...
# https://echarts.apache.org/examples/en/editor.html?c=pictorialBar-bar-transition
...
def makeOption(type, symbol=None):
    return {
        'title': {
        ...
        'series': [
            {
                ...
                'data': [
                    {
                        'value': 157,
                        'symbol': symbol if symbol else pathSymbols['reindeer']
                    },
                    {
                        'value': 21,
                        'symbol': symbol if symbol else pathSymbols['ship']
                    },
                    {
                        'value': 66,
                        'symbol': symbol if symbol else pathSymbols['plane']
                    },
                    {
                        'value': 78,
                        'symbol': symbol if symbol else pathSymbols['train']
                    },
                    {
                        'value': 123,
                        'symbol': symbol if symbol else pathSymbols['car']
                    }
                ]
            },
            {
...
def main():
    ...
    app.layout = html.Div(
        [
            dash_echarts.DashECharts(
                option=makeOption('pictorialBar'),
                id='echarts',
                fun_keys=['delay'],
                funs={
                    "delayFunc": '''
    ...
    def update_echarts(n_intervals):
        optionIndex = (n_intervals + 1) % len(options)
