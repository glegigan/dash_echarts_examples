...
# https://echarts.apache.org/examples/en/editor.html?c=pictorialBar-spirit
...
def main():
    def randomFunc():
        return round(random() * (maxData - 10), 1)
                ...
                children=[
                    dash_echarts.DashECharts(
                        ...
                        funs={
                            'formatterLabel': '''
                            function (params) {
                              return ((params.value / ''' + str(maxData) + ''') * 100).toFixed(1) + ' %';
                            }
                            '''
                        },
                        style={
    ...
    def update_echarts(n_intervals):
        if n_intervals < 0:
            ...
            dynamicData = [randomFunc(), randomFunc(), randomFunc(), randomFunc()]
            option['series'][0]['data'] = dynamicData
            option['series'][1]['data'] = dynamicData
